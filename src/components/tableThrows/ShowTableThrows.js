            ...
            <table className=" table product-section table is-striped is-fullwidth is-bordered  ">
                ...
                <tbody> 
                    ...
                    <tr>
                        ...
                        {showColumn3 && (<td className={throw3.print_options === tableThrow.print_options || throw3.print_options === undefined ? '' : 'highlight'}  >{throw3.print_options}</td>)}
                    </tr>
                    <tr>
                        ...
                        {showColumn3 && (<td className={throw3.fit === tableThrow.fit || throw3.fit === undefined ? '' : 'highlight'}  >{throw3.fit}</td>)}
                    </tr>
                    <tr>
                        ...
                        {showColumn3 && (<td className={throw3.flat_size === tableThrow.flat_size || throw3.flat_size === undefined ? '' : 'highlight'}  >{throw3.flat_size}</td>)}
                    </tr>
                    <tr>
                        ...
                        {showColumn3 && (<td className={throw3.size === tableThrow.size || throw3.size === undefined ? '' : 'highlight'}  >{throw3.size}</td>)}
                    </tr>
                    <tr>
                        {showColumns && (<th  scope="row">Dimensions</th>)}
                        ...
                        {showColumn3 && (<td className={throw3.dimensions1 === tableThrow.dimensions1 || throw3.dimensions1 === undefined ? '' : 'highlight'}  >{throw3.dimensions1}</td>)}
                    </tr>
                    <tr>
                        ...
                        {showColumn3 && (<td className={throw3.material === tableThrow.material || throw3.material === undefined ? '' : 'highlight'}  >{throw3.material}</td>)}
                    </tr>
                    <tr>
                        ...
                        {showColumn3 && (<td className={throw3.finish === tableThrow.finish || throw3.finish === undefined ? '' : 'highlight'}  >{throw3.finish}</td>)}
                    </tr>
                    <tr>
                        ...
                        {showColumn3 && (<td className={throw3.care === tableThrow.care || throw3.care === undefined ? '' : 'highlight'}  >{throw3.care}</td>)}
                    </tr>
                    <tr>
                        ...
                        {showColumn3 && (<td className={throw3.weight === tableThrow.weight || throw3.weight === undefined ? '' : 'highlight'}  >{throw3.weight}</td>)}
                    </tr>
                    <tr>
                        ...
                        {showColumn3 && (<td className={throw3.warranty === tableThrow.warranty || throw3.warranty === undefined ? '' : 'highlight'}  >{throw3.warranty}</td>)}
                    </tr>
