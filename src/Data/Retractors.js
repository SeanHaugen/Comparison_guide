...

{
    ...
    media: "Titan No-curl Opaque hybrid media",
    size: "32\"W x 83.5\"H x 15\"D ",
    weight: "7 lbs",
    base: "Two swivel feet for stability. Base available in black or silver",
    pole: "Shock cord pole makes setup and teardown easy",
...
},
{
    ...
    size: "24\"W x 83.5\"H x 11\"D ",
    weight: "6 lbs",
    base: "Two swivel feet for stability ",
    pole: "Shock cord pole makes setup and teardown easy",
    banner: "Banner attaches with snap rail on top and banner tape on bottom",
    RCAT: 100,
    production: '2 business days',
...
},
{
    ...
    base: "Lightweight aluminum base. Available in black or silver",
    pole: "Shock cord pole makes setup and teardown easy",
    banner: "Banner attaches with snap rail on top and banner tape on bottom",
    RCAT: 100,
    production: '2 business days',
...
},
{
    ...
    pole: "Flip-lever telescoping pole makes setup and adjustment simple.",
    banner: "Flip-open base allows for easy banner changes. Bånner attaches to a leader on the roller using tape",
    RCAT: 800,
    production: '1 business day',
}
